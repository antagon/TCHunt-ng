...
static const struct testmagic_lexrule testmagic_lex[] = {
	...
	{ "GPG symmetrically encrypted data", TMAGIC_CLASS_DATA, TMAGIC_SUBCLASS_PGP, TESTX_SUCCESS },
	...
	{ "PGP symmetric key encrypted data", TMAGIC_CLASS_DATA, TMAGIC_SUBCLASS_PGP, TESTX_SUCCESS },
